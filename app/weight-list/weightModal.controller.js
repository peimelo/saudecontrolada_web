(function () {
    ...
    /** @ngInject */
    function WeightModalController(moment, serverValidateService, sessionService, weight, WeightsResource, toaster, $uibModalInstance) {
        var vm = this;
        vm.cancel = cancel;
        vm.formErrors = {};
        ...
        function submit(form) {
            if (form.$valid) {
                if (vm.weight.id) {
                    WeightsResource.update(vm.weight, function (response) {
...
//# sourceMappingURL=weightModal.controller.js.map